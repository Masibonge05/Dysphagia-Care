...
class GeminiService:
    ...
    async def generate_response(
        ...
        try:
            ...
            # Get system prompt with language instruction and optional user name
            ...
            error_messages = {
                ...
                'ts': "Ku rivaleli, ndzi hlanganile ni xihoxo loko ndzi endla xikombelo xa n’wina. Kombela mi ringeta nakambe.",
