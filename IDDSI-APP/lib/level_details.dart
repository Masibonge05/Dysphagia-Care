...
class LevelDetailsPage extends StatelessWidget {
  ...
  // Shared styled text block used across Testing and Testing Methods
  Widget _styledBlock(String subheading, String content) {
    return Column(
  ...
  // Placeholder for Testing content - Updated images and responsive sizing
  List<Widget> _getTestingContent(int levelNumber, String levelType) {
      ...
      return [
        ...
        Center(
          child: FractionallySizedBox(
            widthFactor: 0.8,
            child: Image.asset(
              'assets/images/Screenshot 2025-06-03 232729.png',
              fit: BoxFit.contain,
            ),
          ),
        ),
       ...
       return [
         // As requested: Level 3 Testing image
         Center(
           child: FractionallySizedBox(
             widthFactor: 0.8,
             child: Image.asset(
    ...
    } else if (levelNumber == 4 && levelType == 'Food') { // Level 4 Food testing image
      return [
        Center(
          child: FractionallySizedBox(
            widthFactor: 0.8,
            child: Image.asset(
              'assets/images/level4testing.jpg',
              fit: BoxFit.contain,
            ),
          ),
        ),
        ...
        Center(
          child: FractionallySizedBox(
            widthFactor: 0.8,
            child: Image.asset(
              'assets/images/level4testing.1.jpg',
              fit: BoxFit.contain,
            ),
          ),
        ),
      ];
    } else if (levelNumber == 4 && levelType == 'Fluid') { // Level 4 Fluid testing image
      return [
        Center(
          child: FractionallySizedBox(
            widthFactor: 0.8,
    ...
    } else if (levelNumber == 5 && levelType == 'Food') { // Level 5 Food
       return [
        Column(
           ...
           children: [
            ...
            Center(
              child: FractionallySizedBox(
                widthFactor: 0.8,
                child: Image.asset('assets/images/F2.png', fit: BoxFit.contain),
              ),
            ),
            const SizedBox(height: 16), // Spacing
    ...
    } else if (levelNumber == 6 && levelType == 'Food') { // Level 6 Food
       return [
        Image.asset(
          'assets/images/level6testing.jpg',
